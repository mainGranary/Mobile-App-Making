...
import {Text, View, ScrollView, TextInput, FlatList, StyleSheet, Button, TouchableOpacity, Image, Alert, TouchableNativeFeedback } from 'react-native';
        ...
        //<View style={{flex:1}}>
            ...
            <View style={{paddingTop:30, margin:30}}>
                <View style={{flexDirection:'row'}}>
                    ...
                    <TextInput placeholder="(이름)" style={{fontSize:25, fontWeight:'bold'}} onChangeText={setUsername} value={username}/>
...
function GifticonInfo({route, navigation}){
    ...
    var a;
    if(image==null) a=null;
    else a=<TouchableOpacity onPress={function(){navigation.navigate("GifticonImage", {this_image:image})}}>
    <Image source={{uri:image}} style={{width:200, height:400, marginLeft:20, marginTop:10}}/>
    </TouchableOpacity>
...
{/* 기프티콘 확대 화면 */}
function GifticonImage({route, navigation}){
    var image=(route.params.this_image);
    ...
    return (
        <NavigationContainer>
            <Stack.Navigator>
                ...
                <Stack.Screen options={{headerShown:true}} name="GifticonImage" component={GifticonImage}/>
            </Stack.Navigator>
        </NavigationContainer>
    )
}