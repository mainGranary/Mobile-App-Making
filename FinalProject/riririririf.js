...
function AddScreen({navigation}){
    ...
    return(
        ...
        <ScrollView contentContainerStyle={{paddingBotton:200}}>
            ...
            <View style={{margin:3}}/>
            <View>
                <TextInput placeholder='어떤 이름으로 저장할까요?'style={{fontSize:15, borderWidth:1, borderRadius:10, borderColor:'dimgray', width:"90%", borderWidth:2, backgroundColor:'rgba(255,255,255,0.5)', padding:10, paddingRight:15, marginLeft:20}} onChangeText={setTitle} value={title}/>
            </View>
                        ...
                        function({item, index}){
                            ...
                            return( 
                                ...
                                <TouchableNativeFeedback onPress={function(){navigation.navigate("GifticonInfo",{key: gifticonList[index], index:index}), console.log(index)}}>
                                    <View style={{backgroundColor:'white', elevation:8,borderRadius:10, flexDirection:'row', margin:10, padding:10, paddingHorizontal:20, alignItems:'center', justifyContent:'space-between'}}>
                                        <Image source={{uri:item.image}} style={{width:80,height:100}}/>
                                        <View style={{flexDirection:'column', margin:3}}>
                                            <Text style={{marginLeft:5, margin:2, fontSize:15, color:'dimgray',fontWeight:'normal'}}>{item.category}</Text>
                                            <Text style={{marginLeft:5, margin:2, fontSize:18, fontWeight:'bold'}}>{item.title}</Text>
                                            <View style={{flexDirection:'row'}}>
...
function GifticonInfo({route, navigation}){
    ...
    return(
        ...
        <ScrollView>
            ...
            <View style={{margin:3}}/>
            <View>
                <TextInput style={{fontSize:15, borderWidth:1, borderRadius:10, borderColor:'dimgray', width:"90%", borderWidth:2, backgroundColor:'rgba(255,255,255,0.5)', padding:10, paddingRight:15, marginLeft:20}} onChangeText={setTitle} value={title}/>
            </View>
